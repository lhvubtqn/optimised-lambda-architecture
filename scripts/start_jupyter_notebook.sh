...
nohup /usr/local/bin/jupyter-notebook --ip=0.0.0.0 --notebook-dir notebooks --allow-root > jupyter/logs/jupyter_notebook.logs 2> jupyter/logs/jupyter_notebook.logs & 
